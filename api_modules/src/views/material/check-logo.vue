<template>
  <div class="root">
    <div class="search">
      <el-input v-model="keyword" placeholder="请输入logo名称" clearable class="input-with-select">
    ...
    >
      <el-table-column prop="name" label="logo名称" show-overflow-tooltip />
      ...
      <el-table-column label="操作">
        <div slot-scope="scope">
          <el-button size="small" type="danger" round @click="deleteLogo(scope.row.id)">删除</el-button>
          <el-button
            size="small"
            type="primary"
            round
