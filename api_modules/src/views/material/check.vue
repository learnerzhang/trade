<template>
  <div class="root">
    <div class="search">
      <el-input v-model="keyword" placeholder="请输入素材名称" clearable class="input-with-select">
    ...
    <div class="my-flex">
      ...
      <el-button class="my-btn" type="primary" @click="searchByTime">开始搜索</el-button>
    </div>
    ...
    >
      ...
      <el-table-column label="操作">
        <div slot-scope="scope">
          <el-button size="small" type="danger" round @click="deleteMaterial(scope.row.id)">删除</el-button>
          <el-button
            size="small"
            type="primary"
            round
...
export default {
  ...
  methods: {
    ...
    searchByTime() {
      const that = this;
      const beginTime = new Date(this.searchTime[0]).getTime();
      const endTime = new Date(this.searchTime[1]).getTime();
