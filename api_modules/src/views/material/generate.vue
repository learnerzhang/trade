      ...
      <el-col :span="12">
        <el-form ref="form" :model="form" label-width="100px" style="width:600px">
          ...
          <el-form-item label="字体与颜色">
            ...
            <el-col :span="8">
              <el-input v-model="form.fontSize" type="number" placeholder="字号:85--100" />
            </el-col>
            <el-col :span="8">
              <span>选择颜色</span>
              <colorPicker v-model="form.color" class="choose-color" />
          ...
          <el-form-item v-if="!type_1" label="文字三">
            <el-input v-model="form.text3" />
          </el-form-item>
          <el-form-item v-if="!type_1" label="文字四">
